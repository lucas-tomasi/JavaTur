...
public class FormaPagamentoView extends javax.swing.JDialog implements FormViewInterface<FormaPagamento>, ListViewInterface<FormaPagamento>
{

    private final FormaPagamentoDAO dao;

    public FormaPagamentoView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("JavaTur/Módulos/FormaPagamento");
        setResizable(false);
        ...
        lblTipoLocal.setText("Formas De Pagamento");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(329, 530, Short.MAX_VALUE))
            .addGroup(layout.createSequentialGroup()
                .addGap(12, 12, 12)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txfDescricao, javax.swing.GroupLayout.PREFERRED_SIZE, 426, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addComponent(txfFiltro, javax.swing.GroupLayout.PREFERRED_SIZE, 289, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnSalvarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSalvarMouseClicked
        ...
        forma.setDescricao(txfDescricao.getText().trim());
        forma.setId( Integer.valueOf( txfId.getText()) );
        forma.setAtivo( cbxAtivo.isSelected() );
        String filtro = "descricao = '"+ forma.getDescricao() +"'";
    ...
    private void btnInativarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnInativarMouseClicked
        ...
        forma = (FormaPagamento) tblTiposLocais.getValueAt( tblTiposLocais.getSelectedRow(), 0);        
        forma.setAtivo( !forma.isAtivo() );
    ...
    public void editar()
    {
        FormaPagamento forma;
        forma = (FormaPagamento) tblTiposLocais.getValueAt( tblTiposLocais.getSelectedRow(), 0);        
        txfDescricao.setText(forma.getDescricao());
        txfId.setText( String.valueOf(forma.getId()) );
        cbxAtivo.setSelected(forma.isAtivo());
    }
    ...
    {
        ArrayList<FormaPagamento> tiposLocais = buscar(obterFiltros());
        
        if( tiposLocais != null )
        {
            redimencionarTabela(tiposLocais.size());
            int cont = 0;
            for (FormaPagamento forma : tiposLocais) 
            {
                tblTiposLocais.setValueAt(forma, cont, 0);
                tblTiposLocais.setValueAt(forma.isAtivo(), cont, 1);
                cont++;
            }
        }
    }
    ...
    {
        ArrayList<FormaPagamento> tiposLocais;
        if( filtro != null )
        {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormaPagamentoView dialog = new FormaPagamentoView(new javax.swing.JFrame(), true);
