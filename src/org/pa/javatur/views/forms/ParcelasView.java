...
import org.pa.javatur.reports.Parcelas;

public class ParcelasView extends javax.swing.JDialog{
    
    public ParcelasView(java.awt.Frame parent, boolean modal ) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("JavaTur/Relatórios/Parcelas");
        setResizable(false);
        ...
        btnBuscar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/pa/javatur/images/find.png"))); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txfData, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(5, 5, 5)
    ...
    private void btnGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarActionPerformed
        if( Util.validarData(txfData.getText()) || txfData.getText().trim().equals("/  /") )
        {
            String situacao = "";
            ...
            new Parcelas( Util.converterData( txfData.getText() ) , situacao , txfIdTurista.getText() );
            this.setVisible(false);
        }
        else
        {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ParcelasView dialog = new ParcelasView(new javax.swing.JFrame(), true );
